source "scripts_own/init_soc.tcl"
...
# Read floorplanning and flip-chip information.
source "scripts_own/fp_soc.tcl"
...
addRing -layer {top metal5 bottom metal5 left metal6 right metal6} -spacing {top 1.5 bottom 1.5 left 1.5 right 1.5} -width {top 2 bottom 2 left 2 right 2} -center 1 -nets { VDD VSS }
...
puts "* Design:  ${OUTPUTDIR}/design.invs"
puts "*"
