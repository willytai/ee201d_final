source "scripts_own/init_3d_f2f_bottom.tcl"
...
create_library_set -name WC_LIB_SLOW -timing [list $nanlib/NangateOpenCellLibrary_slow_ccs.lib $libdir/sram_32_256_freepdk45_SS_1p0V_25C.lib $libdir/IOCELLBUFANTENNAIN_ss.lib $libdir/IOCELLBUFANTENNAOUT_ss.lib $libdir/tsv.lib]
...
create_library_set -name WC_LIB_FAST -timing [list $nanlib/NangateOpenCellLibrary_fast_ccs.lib $libdir/sram_32_256_freepdk45_FF_1p0V_25C.lib $libdir/IOCELLBUFANTENNAIN_ff.lib $libdir/IOCELLBUFANTENNAOUT_ff.lib $libdir/tsv.lib]
...
source "scripts_own/fp_3d_f2f_bottom.tcl"
...
source "scripts_own/timing_check_f2f_bot.tcl" > ${OUTPUTDIR}/tsv_timing.check
